<script lang="ts">
	...
	const title = $derived(data.hskLevel ? `HSK ${data.hskLevel} - Finished vocabulary` : 'All finished vocabulary');
</script>
	...
	<div class="hero min-h-[40vh]">
		<div class="hero-content text-center">
			<div class="max-w-sm">
				...
				<p class="text-base-content/50">No finished words yet.</p>
...
{:else}
	<p class="text-base-content/50 text-sm mb-4">
		{data.words.length} word{data.words.length === 1 ? '' : 's'} finished
	</p>
